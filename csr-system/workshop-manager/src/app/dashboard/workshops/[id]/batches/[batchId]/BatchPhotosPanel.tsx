...
export function BatchPhotosPanel({ workshopId, batchId, photos }: { workshopId: string; batchId: string; photos: BatchPhoto[] }) {
  const boundAction = uploadBatchPhotoAction.bind(null, workshopId, batchId);
