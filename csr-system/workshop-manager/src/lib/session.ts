...
export const ACCESS_COOKIE = "csr_workshopmanager_access_token";
export const REFRESH_COOKIE = "csr_workshopmanager_refresh_token";
export const USER_COOKIE = "csr_workshopmanager_user";
