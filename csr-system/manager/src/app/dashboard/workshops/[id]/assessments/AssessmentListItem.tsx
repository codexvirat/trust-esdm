...
export function AssessmentListItem({ workshopId, assessment, attempts }: { workshopId: string; assessment: Assessment; attempts: AssessmentAttempt[] }) {
    ...
    <li className="py-4">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          type="button"
          disabled={pending}
          onClick={() => startTransition(() => setAssessmentEnabledAction(workshopId, assessment._id, !assessment.isEnabled))}
