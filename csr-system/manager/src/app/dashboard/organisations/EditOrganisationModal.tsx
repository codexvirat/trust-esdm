...
export function EditOrganisationModal({ organisation, onClose }: { organisation: Organisation; onClose: () => void }) {
  const bound = updateOrganisationAction.bind(null, organisation._id);
