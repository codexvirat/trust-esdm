...
export function CreateSessionForm({ workshopId, batchId }: { workshopId: string; batchId: string }) {
  const [open, setOpen] = useState(false);
  const bound = generateAttendanceSessionAction.bind(null, workshopId, batchId);
