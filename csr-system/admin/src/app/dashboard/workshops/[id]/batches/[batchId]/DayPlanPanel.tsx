...
export function DayPlanPanel({
  ...
  const boundAction = addDayPlanEntryAction.bind(null, projectId, workshopId, batchId);
            ...
            return (
              <li key={entry._id} className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 text-sm">
                ...
                <button
                  ...
                  onClick={() => startRemove(() => removeDayPlanEntryAction(projectId, workshopId, batchId, entry._id))}
