...
import type { FeedbackBankQuestion, FeedbackFormQuestion, FeedbackQuestionType } from "@/lib/types";
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6">
      ...
      <div className="mt-4 flex flex-col gap-1">
        <label htmlFor="feedback-title" className="text-sm font-medium text-slate-700">
          Form name
        </label>
        <input
          id="feedback-title"
