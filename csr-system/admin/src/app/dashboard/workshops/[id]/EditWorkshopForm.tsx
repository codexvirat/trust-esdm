...
export function EditWorkshopForm({ workshop, projectId }: { workshop: WorkshopSummary; projectId: string }) {
  const [open, setOpen] = useState(false);
  const boundAction = updateWorkshopAction.bind(null, projectId, workshop._id);
