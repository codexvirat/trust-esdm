...
export function QuestionRow({ projectId, question }: { projectId: string; question: Question }) {
    ...
    <li className="py-3">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          disabled={pending}
          onClick={() => {
            if (window.confirm("Delete this question?")) startTransition(() => deleteQuestionAction(projectId, question._id));
          }}
