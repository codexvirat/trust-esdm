...
export function RevokeButton({ projectId, certificateId }: { projectId: string; certificateId: string }) {
  const [open, setOpen] = useState(false);
  const bound = revokeCertificateAction.bind(null, projectId, certificateId);
