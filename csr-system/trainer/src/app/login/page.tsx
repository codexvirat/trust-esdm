  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
        <h1 className="text-xl font-semibold text-slate-900">Trainer Portal</h1>
        <p className="mt-1 text-sm text-slate-500">Sign in to view your assigned batches, mark attendance, and manage assessments.</p>
        ...
        <form action={action} className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="projectSlug" className="text-sm font-medium text-slate-700">
              Project slug <span className="font-normal text-slate-400">(only if asked)</span>
            </label>
            <input
              id="projectSlug"
              name="projectSlug"
          ...
          <button
            type="submit"
            disabled={pending}
            className="mt-2 rounded-md bg-indigo-700 px-4 py-2 text-sm font-medium text-white transition hover:bg-indigo-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
