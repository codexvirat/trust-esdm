...
export const ACCESS_COOKIE = "csr_candidate_access_token";
export const REFRESH_COOKIE = "csr_candidate_refresh_token";
export const USER_COOKIE = "csr_candidate_user";
